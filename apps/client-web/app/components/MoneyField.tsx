...
type MoneyFieldProps = {
  ...
  /** Input label */
  label: string;
  /** Number of decimal places (default 4 for money) */
  decimals?: number;
  disabled?: boolean;
  'data-testid'?: string;
};
...
/**
 * MUI TextField wrapper for money/currency input with RHF Controller.
 *
 * Handles:
 * - Locale-aware formatting on blur and on language change (e.g. "2" → "2.0000")
