...
Use `fetcher.formData` to show expected results immediately. See [pending-ui.md](./pending-ui.md) for complete patterns.

### Typing useFetcher

See [type-safety.md](./type-safety.md) for typing patterns.
